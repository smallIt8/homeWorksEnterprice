...
public class RegexConstant {
	...
	public static final String TRANSACTION_NAME_REGEX = "^[a-zA-Zа-яА-ЯёЁ]{2,50}$";
	public static final String CATEGORY_NAME_REGEX = "^[a-zA-Zа-яА-ЯёЁ]{2,50}$";
	public static final String FINANCIAL_GOAL_NAME_REGEX = "^[a-zA-Zа-яА-ЯёЁ]{2,50}$";
	public static final String BUDGET_NAME_REGEX = "^[a-zA-Zа-яА-ЯёЁ]{2,50}$";
