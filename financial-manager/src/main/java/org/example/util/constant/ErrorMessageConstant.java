...
public class ErrorMessageConstant {
	...
	// ========== Сообщения о предупреждениях некорректного ввода ==========
	public static final String WARNING_ENTER_USER_NAME_MESSAGE =
			"""
					Неверный ввод.
					Логин должен содержать от 4 до 100 символов, включая буквы и цифры.
					""";

	public static final String WARNING_ENTER_PASSWORD_MESSAGE =
			"""
					Неверный ввод.
	...
	public static final String WARNING_ENTER_FIRST_NAME_MESSAGE =
			"""
					Неверный ввод.
	...
	public static final String WARNING_ENTER_LAST_NAME_MESSAGE =
			"""
					Неверный ввод.
	...
	public static final String WARNING_ENTER_EMAIL_MESSAGE =
			"""
					Неверный ввод.
					...
					""";
	public static final String WARNING_ENTER_TRANSACTION_NAME_MESSAGE =
			"""
					Неверный ввод.
					Имя должно содержать от 2 до 50 символов
					включая буквы.
					""";
	public static final String WARNING_ENTER_BUDGET_NAME_MESSAGE =
			"""
					Неверный ввод.
					Имя должно содержать от 2 до 50 символов
					включая буквы.
					""";
	public static final String WARNING_ENTER_FINANCIAL_GOAL_NAME_MESSAGE =
			"""
					Неверный ввод.
					Имя должно содержать от 2 до 50 символов
					включая буквы.
					""";
	public static final String WARNING_ENTER_CATEGORY_NAME_MESSAGE =
			"""
					Неверный ввод.
					Имя должно содержать от 2 до 50 символов
					включая буквы.
					""";
	public static final String WARNING_ENTER_FAMILY_NAME_MESSAGE =
			"""
					Неверный ввод.
					Имя должно содержать от 2 до 50 символов
					включая буквы.
					""";
	public static final String WARNING_ENTER_TRANSACTION_AMOUNT_MESSAGE = "Минимальная стоимость транзакции должна быть не менее 0,01";
	public static final String WARNING_ENTER_BUDGET_LIMIT_MESSAGE = "Минимальный лимит бюджета должен быть не менее 0,01";
	public static final String WARNING_ENTER_FINANCIAL_GOAL_TARGET_AMOUNT_MESSAGE = "Минимальная цель долгосрочной финансовой цели должна быть не менее 0,01";
	public static final String WARNING_TRANSACTION_NAME_NOT_NULL_MESSAGE = "Имя транзакции не может быть пустым";
	public static final String WARNING_TRANSACTION_TYPE_NOT_NULL_MESSAGE = "Тип транзакции не может быть пустым";
	public static final String WARNING_SELECT_TRANSACTION_CATEGORY_NOT_NULL_MESSAGE = "Категория транзакции не может быть пустой";
	public static final String WARNING_TRANSACTION_AMOUNT_NOT_NULL_MESSAGE = "Стоимость транзакции не может быть пустой";
	public static final String WARNING_TRANSACTION_DATE_NOT_NULL_MESSAGE = "Дата транзакции не может быть пустой";
	public static final String WARNING_TRANSACTION_DATE_NOT_CURRENT_OR_PAST_MESSAGE = "Дата транзакции не может быть позже текущей даты";
	public static final String WARNING_BUDGET_NAME_NOT_NULL_MESSAGE = "Имя бюджета не может быть пустым";
	public static final String WARNING_SELECT_BUDGET_CATEGORY_NOT_NULL_MESSAGE = "Категория бюджета не может быть пустой";
	public static final String WARNING_BUDGET_LIMIT_NOT_NULL_MESSAGE = "Лимит бюджета не может быть пустым";
	public static final String WARNING_BUDGET_PERIOD_NOT_NULL_MESSAGE = "Период бюджета не может быть пустым";
	public static final String WARNING_SELECT_BUDGET_CATEGORY_NOT_INCOME_MESSAGE = "Бюджет не может быть установлен на приходную категорию";
	public static final String WARNING_BUDGET_PERIOD_NOT_CURRENT_OR_FUTURE_MESSAGE = "Период бюджета не может раньше текущего месяца";
	public static final String WARNING_FINANCIAL_GOAL_NAME_NOT_NULL_MESSAGE = "Имя долгосрочной финансовой цели не может быть пустым";
	public static final String WARNING_FINANCIAL_GOAL_TARGET_AMOUNT_NOT_NULL_MESSAGE = "Цель долгосрочной финансовой цели не может быть пустой";
	public static final String WARNING_FINANCIAL_GOAL_END_DATE_NOT_NULL_MESSAGE = "Конечная дата долгосрочной финансовой цели не может быть пустой";
	public static final String WARNING_FINANCIAL_GOAL_END_DATE_NOT_CURRENT_OR_FUTURE_MESSAGE = "Конечная дата долгосрочной финансовой цели не может быть раньше текущей даты";
	public static final String WARNING_CATEGORY_NAME_NOT_NULL_MESSAGE = "Имя категории не может быть пустым";
	public static final String WARNING_CATEGORY_TYPE_NOT_NULL_MESSAGE = "Тип категории не может быть пустым";
	public static final String WARNING_FAMILY_NAME_NOT_NULL_MESSAGE = "Имя семейной группы не может быть пустым";
